...
const Services: React.FC = () => {
  ...
  // Create animations for services
  const serviceAnimations = Array(6).fill(null).map((_, index) =>
    useSpring({
  ...
  // Create animations for pricing plans
  const pricingAnimations = Array(3).fill(null).map((_, index) =>
    useSpring({
      from: { opacity: 0, transform: 'translateY(20px)' },
      to: { opacity: 1, transform: 'translateY(0)' },
      delay: 200 * index,
